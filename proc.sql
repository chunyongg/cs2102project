...
BEGIN 
    ...
    LOOP 
        ...
        name := r.emp_name;
        status := 'part_time';
        worked_hours := find_hours_worked(current_date, emp_id);
...
BEGIN 
    ...
    SET hours_worked = hours_worked + new_hours_worked
    WHERE emp_id = inst_id AND month_year = date_trunc('month', NEW.sess_date);
    RETURN NULL;
END;
$$ LANGUAGE PLPGSQL;
