...
(default, 3, 'Randomized Algorithms', 'The module will cover basic concepts in the design and analysis of randomized algorithms', 'Algorithms and Theory');
...
(11,  '2021-01-02', '2021-01-02', '2021-02-02', '2020-12-23', 20, 200.00, 20,  1, 10), -- algo and theory, 1 session (room_id = 1, capacity = 20)
(12,  '2021-02-02', '2021-02-02', '2021-03-02', '2021-01-23', 20, 200.00, 20, 2, 10),  -- algo and theory, 1 session (room_id = 2, capacity = 20)
(13,  '2021-03-02', '2021-03-02', '2021-04-02', '2021-02-20', 20, 200.00, 20, 3, 10),  -- algo and theory, 1 session (room_id = 3, capacity = 20)
(14,  '2021-04-02', '2021-04-02', '2021-05-02', '2021-03-23', 70, 200.00, 70, 4, 10),  -- algo and theory, 2 sessions (room_id = 11 & 21, capacity = 30 + 40)
(15,  '2021-05-02', '2021-05-02', '2021-06-02', '2021-04-22', 70, 200.00, 70, 5, 10),  -- algo and theory, 2 sessions (room_id = 12 & 22, capacity = 30 + 40)
(16,  '2021-06-02', '2021-06-02', '2021-07-02', '2021-05-23', 30, 200.00, 30, 6, 35),  -- algo and theory, 1 session (room_id = 13, capacity = 30)
(17,  '2021-07-02', '2021-07-02', '2021-08-02', '2021-06-22', 120, 200.00, 120, 7, 35), -- algo and theory, 3 session (room_id = 23, 24 & 25, capacity = 40 + 40 + 40)
(18,  '2021-08-02', '2021-08-02', '2021-09-02', '2021-07-23', 50, 200.00, 50, 8, 35),  -- algo and theory, 2 sessions (room_id = 6 & 7, capacity = 25 + 25)
(19,  '2021-09-02', '2021-09-02', '2021-10-02', '2021-08-23', 40, 200.00, 40, 9, 35),  -- algo and theory, 2 sessions (room_id = 4 & 5, capacity = 20 + 20)
(20, '2021-10-02', '2021-10-02', '2021-11-02', '2021-09-22', 70, 200.00, 70, 10, 35); -- algo and theory, 2 sessions (room_id = 16 & 17 capacity = 35 + 35)
